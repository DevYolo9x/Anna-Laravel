...
class Helper
{
    ...
    function catalogue_project_relation_ship($productid = 0, $catalogueid = 0, $tmp_catalogue = [], $module = '')
    {
        /*$_catalogue_relation_ship[] = array(
            'module' => $module,
            'moduleid' => $productid,
        ...
        DB::table('projects_relationships')->insert($_catalogue_relation_ship);
    }

    function catalogue_service_relation_ship($productid = 0, $catalogueid = 0, $tmp_catalogue = [], $module = '')
    {
        /*$_catalogue_relation_ship[] = array(
            'module' => $module,
            'moduleid' => $productid,
        ...
        DB::table('services_relationships')->insert($_catalogue_relation_ship);
    }

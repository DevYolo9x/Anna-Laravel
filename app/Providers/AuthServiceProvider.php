...
use App\Policies\CategoryProjectPolicy;
use App\Policies\ServicePolicy;
use App\Policies\CategoryServicePolicy;
...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->gateProduct();
        //dự án
        $this->gateProjectCategory();
        $this->gateProject();
        //dịch vụ
        $this->gateServiceCategory();
        $this->gateService();
        //tag
        $this->gateTag();
        //brand
    ...
    public function gateServiceCategory()
    {
        Gate::define('category_services_index', [CategoryServicePolicy::class, 'index']);
        Gate::define('category_services_create', [CategoryServicePolicy::class, 'create']);
        Gate::define('category_services_edit', [CategoryServicePolicy::class, 'edit']);
        Gate::define('category_services_destroy', [CategoryServicePolicy::class, 'destroy']);
    }
    public function gateService()
    {
        Gate::define('services_index', [ServicePolicy::class, 'index']);
        Gate::define('services_create', [ServicePolicy::class, 'create']);
        Gate::define('services_edit', [ServicePolicy::class, 'edit']);
        Gate::define('services_destroy', [ServicePolicy::class, 'destroy']);
    }
    public function gateProjectCategory()
    {
        Gate::define('category_projects_index', [CategoryProjectPolicy::class, 'index']);
        Gate::define('category_projects_create', [CategoryProjectPolicy::class, 'create']);
        Gate::define('category_projects_edit', [CategoryProjectPolicy::class, 'edit']);
        Gate::define('category_projects_destroy', [CategoryProjectPolicy::class, 'destroy']);
    }
    public function gateProject()
    {
        Gate::define('projects_index', [ProjectPolicy::class, 'index']);
        Gate::define('projects_create', [ProjectPolicy::class, 'create']);
        Gate::define('projects_edit', [ProjectPolicy::class, 'edit']);
        Gate::define('projects_destroy', [ProjectPolicy::class, 'destroy']);
    }

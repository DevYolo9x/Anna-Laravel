...
class CategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // die;
        $module = $this->table;
        $data =  CategoryProduct::select('id', 'slug', 'title', 'ishome', 'home_1', 'home_2', 'highlight', 'isaside', 'isfooter', 'order', 'publish', 'lft', 'rgt', 'level', 'created_at', 'userid_created', 'parentid')->with('user')->with('countProduct')->where('alanguage', config('app.locale'))->orderBy('lft', 'ASC');

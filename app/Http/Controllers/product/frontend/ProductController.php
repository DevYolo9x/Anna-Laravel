...
class ProductController extends Controller
{
    ...
    public function index(Request $request, $slug = "", $id = 0)
    {
        ...
        $productSame =  $productSame->select('category_products.title as titleC', 'category_products.slug as slugC', 'products.id', 'products.code', 'products.title', 'products.image_json', 'products.image', 'products.slug', 'products.price', 'products.price_sale', 'products.price_contact');

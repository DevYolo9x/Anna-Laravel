...
//        dd(\DB::getQueryLog());
    ...
    public function delete_function($id = 0, $module = '', $child = 0)
    {
        ...
        if ($module == 'projects') {
            //xóa catalogue_relationship
            DB::table('projects_relationships')->where('moduleid', $id)->where('module', $module)->delete();
            //xóa tags_relationship
            DB::table('tags_relationships')->where('module_id', $id)->where('module', $module)->delete();
        }
        //services
        if ($module == 'services') {
            //xóa catalogue_relationship
            DB::table('services_relationships')->where('moduleid', $id)->where('module', $module)->delete();
            //xóa tags_relationship
            DB::table('tags_relationships')->where('module_id', $id)->where('module', $module)->delete();
        }
        //media
        ...
        //media
        if ($module == 'personal') {
            //xóa personals_relationships
            DB::table('personals_relationships')->where('personalsId', $id)->delete();
            //xóa personals
        ...
        if ($module == 'category_articles' || $module == 'category_projects' || $module == 'category_services' || $module == 'category_products' || $module == 'category_media' || $module == 'brands') {
        ...
        //xóa custom fields
        if ($module == 'category_articles' || $module == 'articles' || $module == 'category_services' || $module == 'services' || $module == 'category_projects' || $module == 'projects' || $module == 'category_products' || $module == 'media' || $module == 'category_media' || $module == 'attributes' || $module == 'category_attributes' || $module == 'brands' || $module == 'tags' || $module == 'pages') {

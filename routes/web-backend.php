...
use App\Http\Controllers\project\backend\CategoryController as BackendCategoryProjectController;
//service module
use App\Http\Controllers\service\backend\ServiceController;
use App\Http\Controllers\service\backend\CategoryController as BackendCategoryServiceController;
//product module
...
Route::group(['middleware' => 'locale'], function () {
    Route::group(['prefix' => env('APP_ADMIN'), 'middleware' => ['auth:web']], function () {
        ...
        //danh mục project
        Route::group(['prefix' => '/category-projects'], function () {
            Route::get('/index', [BackendCategoryProjectController::class, 'index'])->name('category_projects.index')->middleware('can:category_projects_index');
            Route::get('/create', [BackendCategoryProjectController::class, 'create'])->name('category_projects.create')->middleware('can:category_projects_create');
            Route::post('/store', [BackendCategoryProjectController::class, 'store'])->name('category_projects.store')->middleware('can:category_projects_create');
            Route::get('/edit/{id}', [BackendCategoryProjectController::class, 'edit'])->name('category_projects.edit')->middleware('can:category_projects_edit');
            Route::post('/update/{id}', [BackendCategoryProjectController::class, 'update'])->name('category_projects.update')->middleware('can:category_projects_edit');
            Route::get('/destroy/{id}', [BackendCategoryProjectController::class, 'destroy'])->name('category_projects.destroy')->middleware('can:category_projects_destroy');
        });
        //danh sách project
        Route::group(['prefix' => '/projects'], function () {
            Route::get('/index', [ProjectController::class, 'index'])->name('projects.index')->middleware('can:projects_index');
            Route::get('/create', [ProjectController::class, 'create'])->name('projects.create')->middleware('can:projects_create');
            Route::post('/store', [ProjectController::class, 'store'])->name('projects.store');
            Route::get('/edit/{id}', [ProjectController::class, 'edit'])->name('projects.edit')->middleware('can:projects_edit');
            Route::post('/update/{id}', [ProjectController::class, 'update'])->name('projects.update')->middleware('can:projects_edit');
            Route::get('/destroy/{id}', [ProjectController::class, 'destroy'])->name('projects.destroy')->middleware('can:projects_destroy');
            Route::post('/select2', [ProjectController::class, 'select2']);
        });
        //danh mục service
        Route::group(['prefix' => '/category-services'], function () {
            Route::get('/index', [BackendCategoryServiceController::class, 'index'])->name('category_services.index')->middleware('can:category_services_index');
            Route::get('/create', [BackendCategoryServiceController::class, 'create'])->name('category_services.create')->middleware('can:category_services_create');
            Route::post('/store', [BackendCategoryServiceController::class, 'store'])->name('category_services.store')->middleware('can:category_services_create');
            Route::get('/edit/{id}', [BackendCategoryServiceController::class, 'edit'])->name('category_services.edit')->middleware('can:category_services_edit');
            Route::post('/update/{id}', [BackendCategoryServiceController::class, 'update'])->name('category_services.update')->middleware('can:category_services_edit');
            Route::get('/destroy/{id}', [BackendCategoryServiceController::class, 'destroy'])->name('category_services.destroy')->middleware('can:category_services_destroy');
        });
        //danh sách service
        Route::group(['prefix' => '/services'], function () {
            Route::get('/index', [ServiceController::class, 'index'])->name('services.index')->middleware('can:services_index');
            Route::get('/create', [ServiceController::class, 'create'])->name('services.create')->middleware('can:services_create');
            Route::post('/store', [ServiceController::class, 'store'])->name('services.store');
            Route::get('/edit/{id}', [ServiceController::class, 'edit'])->name('services.edit')->middleware('can:services_edit');
            Route::post('/update/{id}', [ServiceController::class, 'update'])->name('services.update')->middleware('can:services_edit');
            Route::get('/destroy/{id}', [ServiceController::class, 'destroy'])->name('services.destroy')->middleware('can:services_destroy');
            Route::post('/select2', [ServiceController::class, 'select2']);
        });
        //danh mục media

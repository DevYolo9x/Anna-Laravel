...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('services.update',['id' => $detail->id])}}" method="post" enctype="multipart/form-data">
            ...
            <div class=" box p-5">
                ...
                <div class="tab-content">
                    <div id="example-tab-homepage" class="tab-pane leading-relaxed active" role="tabpanel" aria-labelledby="example-homepage-tab">
                        <div>
                            <label class="form-label text-base font-semibold">Tiêu đề dịch vụ</label>
                        ...
                        <div class="mt-3">
                            <label class="form-label text-base font-semibold">Chi tiết dịch vụ</label>
                            <div class="mt-2">

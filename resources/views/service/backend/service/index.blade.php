...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class=" col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            ...
            @can('services_create')
            <a href="{{route('services.create')}}" class="btn btn-primary shadow-md mr-2">Thêm mới</a>
            @endcan
        </div>
        <!-- BEGIN: Data List -->
                ...
                <tbody id="table_data" role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td class="whitespace-nowrap">
                            ...
                            <a class="text-danger" href="{{route('services.index',['catalogueid' => $c->id])}}"><?php echo !empty($kc == 0) ? '' : ',' ?>{{$c->title}}</a><br>
                            @endforeach
                        </td>
                        ...
                        <td class="table-report__action w-56 ">
                            <div class="flex justify-center items-center">
                                @can('services_edit')
                                <a class="flex items-center mr-3" href="{{ route('services.edit',['id'=>$v->id]) }}">
                                    <i data-lucide="check-square" class="w-4 h-4 mr-1"></i>
                                    Edit
                                </a>
                                @endcan
                                @can('services_destroy')
                                <a class="flex items-center text-danger ajax-delete" href="javascript:;" data-id="<?php echo $v->id ?>" data-module="<?php echo $module ?>" data-child="0" data-title="Lưu ý: Khi bạn xóa dịch vụ, dịch vụ sẽ bị xóa vĩnh viễn. Hãy chắc chắn rằng bạn muốn thực hiện hành động này!">

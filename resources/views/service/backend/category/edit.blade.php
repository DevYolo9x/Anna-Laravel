...
@section('title')
<title>Cập nhập danh mục dịch vụ</title>
@endsection
<!--START: breadcrumb -->
@section('breadcrumb')
<?php
...
<div class="content">
    <div class=" flex items-center mt-8">
        <h1 class="text-lg font-medium mr-auto">
            Cập nhập danh mục dịch vụ
        </h1>
    </div>
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('category_services.update',['id' => $detail->id])}}" method="post" enctype="multipart/form-data">

...
@section('content')
    ...
    <div class="page-wrapper">
                                    ...
                                    <div class="main-menu__main-menu-box-inner">
                                        ...
                                        <ul class="main-menu__list">
                                            <li
                                                ...
                                                <a href="index.html"><span>NEW</span>Demos</a>
                                                <ul>
                                                    <li>
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul>
                                                    <li><a href="about.html">About</a></li>
                                                    <li class="is-new-menu"><a href="sign-in.html"><span>NEW</span>Sign
                                                            in</a></li>
                                                    <li class="is-new-menu"><a
                                                            href="make-a-claim-death.html"><span>NEW</span>Make a
                                                            claim</a>
                                                    </li>
                                                    <li class="is-new-menu"><a
                                                            href="policy-proposal.html"><span>NEW</span>Policy
                                                            proposal</a></li>
                                            ...
                                            <li class="dropdown current">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="is-new-menu"><a
                                                            href="news-sidebar-left.html"><span>NEW</span>News left
                                                            sidebar</a></li>
        ...
        <section class="page-header">
            ...
            <div class="page-header-shape-1"><img src="assets/images/shapes/page-header-shape-1.png" alt="">
            </div>
            <div class="container">
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="news-details__left">
                            ...
                            <div class="comment-form">
                                ...
                                <form action="https://assets/inc/sendemail.php"
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar__single sidebar__category">
                                ...
                                <ul class="sidebar__category-list list-unstyled">
                                    <li><a href="news-details.html">Life Insurance <span
                                                class="fas fa-angle-double-right"></span></a></li>
                                    <li class="active"><a href="news-details.html">Health <span
                                                class="fas fa-angle-double-right"></span></a></li>
                                    <li><a href="news-details.html">Policies <span
                                                class="fas fa-angle-double-right"></span></a>
                                    </li>
                                    <li><a href="news-details.html">Payments <span
                                                class="fas fa-angle-double-right"></span></a></li>
                                    <li><a href="news-details.html">Home Insurance <span
                                                class="fas fa-angle-double-right"></span></a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="mobile-nav__content">
            ...
            <div class="mobile-nav__container">
                <ul class="main-menu__list">
                                                        ...
                                                        <div class="demos-one__single">
                                                            ...
                                                            <div class="demos-one__image">
                                                                <img width="370" height="431"
                                                                    ...
                                                                    alt="Home Dark">
                                                                <div class="demos-one__buttons">
                                                                    <a href="index6.html" class="thm-btn">Multi
                                                                        Page </a>
                                                                    <a href="index6-one-page.html" class="thm-btn">One
                                                                        Page</a>
                                                                </div>
                                                                <!-- /.demos-one__buttons -->
                                                            </div><!-- /.demos-one__image -->
                                                        ...
                                                        <div class="demos-one__single">
                                                            ...
                                                            <div class="demos-one__image">
                                                                <img width="370" height="431"
                                                                    ...
                                                                    alt="Home Dark">
                                                                <div class="demos-one__buttons">
                                                                    <a href="index7.html" class="thm-btn">Multi
                                                                        Page </a>
                                                                    <a href="index7-one-page.html" class="thm-btn">One
                                                                        Page</a>
                                                                </div>
                                                                <!-- /.demos-one__buttons -->
                                                            </div><!-- /.demos-one__image -->
                                                        ...
                                                        <div class="demos-one__single">
                                                            <div class="demos-one__image">
                                                                <img width="370" height="431"
                                                                    ...
                                                                    alt="Home Dark">
                                                                <div class="demos-one__buttons">
                                                                    <a href="index4.html" class="thm-btn">Multi
                                                                        Page </a>
                                                                    <a href="index4-one-page.html" class="thm-btn">One
                                                                        Page</a>
                                                                </div>
                                                                <!-- /.demos-one__buttons -->
                                                            </div><!-- /.demos-one__image -->
                                                        ...
                                                        <div class="demos-one__single">
                                                            <div class="demos-one__image">
                                                                <img width="370" height="431"
                                                                    ...
                                                                    alt="Home Dark">
                                                                <div class="demos-one__buttons">
                                                                    <a href="index5.html" class="thm-btn">Multi
                                                                        Page </a>
                                                                    <a href="index5-one-page.html" class="thm-btn">One
                                                                        Page</a>
                                                                </div>
                                                                <!-- /.demos-one__buttons -->
                                                            </div><!-- /.demos-one__image -->
                                                        ...
                                                        <div class="demos-one__single">
                                                            <div class="demos-one__image">
                                                                <img width="370" height="431"
                                                                    ...
                                                                    alt="Home Page 01">
                                                                <div class="demos-one__buttons">
                                                                    <a href="index.html" class="thm-btn">Multi
                                                                        Page </a>
                                                                    <a href="index-one-page.html" class="thm-btn">One Page
                                                                    </a>
                                                                </div>
                                                                <!-- /.demos-one__buttons -->
                                                            </div><!-- /.demos-one__image -->
                                                        ...
                                                        <div class="demos-one__single">
                                                            <div class="demos-one__image">
                                                                <img width="370" height="431"
                                                                    ...
                                                                    alt="Home Page 02">
                                                                <div class="demos-one__buttons">
                                                                    <a href="index2.html" class="thm-btn">Multi
                                                                        Page </a>
                                                                    <a href="index2-one-page.html" class="thm-btn">One
                                                                        Page</a>
                                                                </div>
                                                                <!-- /.demos-one__buttons -->
                                                            </div><!-- /.demos-one__image -->
                                                        ...
                                                        <div class="demos-one__single">
                                                            <div class="demos-one__image">
                                                                <img width="370" height="431"
                                                                    ...
                                                                    alt="Home page 03">
                                                                <div class="demos-one__buttons">
                                                                    <a href="index3.html" class="thm-btn">Multi
                                                                        Page </a>
                                                                    <a href="index3-one-page.html" class="thm-btn">One
                                                                        Page</a>
                                                                </div>
                                                                <!-- /.demos-one__buttons -->
                                                            </div><!-- /.demos-one__image -->
                                                        ...
                                                        <div class="demos-one__single">
                                                            <div class="demos-one__image">
                                                                <img width="370" height="431"
                                                                    ...
                                                                    alt="Home Boxed">
                                                                <div class="demos-one__buttons">
                                                                    <a href="index-boxed.html" class="thm-btn">View
                                                                        Page</a>
                                                                </div>
                                                                <!-- /.demos-one__buttons -->
                                                            </div><!-- /.demos-one__image -->
                                                        ...
                                                        <div class="demos-one__single">
                                                            <div class="demos-one__image">
                                                                <img width="370" height="431"
                                                                    ...
                                                                    alt="Home Dark">
                                                                <div class="demos-one__buttons">
                                                                    <a href="index-dark.html" class="thm-btn">View
                                                                        Page</a>
                                                                </div>
                                                                <!-- /.demos-one__buttons -->
                                                            </div><!-- /.demos-one__image -->
                    ...
                    <li class="dropdown">
                        <a href="#">Pages<button aria-label="dropdown toggler"><i
                                    class="fa fa-angle-down"></i></button></a>
                        <ul>
                            <li><a href="about.html">About</a></li>
                            <li class="is-new-menu"><a href="sign-in.html"><span>NEW</span>Sign in</a></li>
                            <li class="is-new-menu"><a href="make-a-claim-death.html"><span>NEW</span>Make a
                                    claim</a>
                            </li>
                            <li class="is-new-menu"><a href="policy-proposal.html"><span>NEW</span>Policy
                                    proposal</a></li>
                            <li><a href="portfolio.html">Portfolio</a></li>
                            <li><a href="portfolio-carousel.html">Portfolio carousel</a></li>
                            <li><a href="portfolio-details.html">Portfolio details</a></li>
                    ...
                    <li class="dropdown">
                        <a href="#">Insurance <button aria-label="dropdown toggler"><i
                                    class="fa fa-angle-down"></i></button></a>
                        <ul>
                            <li><a href="insurance-01.html">Insurance 01</a></li>
                            <li><a href="insurance-02.html">Insurance 02</a></li>
                    ...
                    <li class="dropdown">
                        <a href="products.html">Shop<button aria-label="dropdown toggler"><i
                                    class="fa fa-angle-down"></i></button></a>
                        <ul>
                            <li><a href="products.html">Shop</a></li>
                            <li><a href="product-details.html">Shop details</a></li>
                    ...
                    <li class="dropdown current">
                        <a href="#">News<button aria-label="dropdown toggler"><i
                                    class="fa fa-angle-down"></i></button></a>
                        <ul>
                            <li><a href="news.html">News</a></li>
                            <li><a href="news-carousel.html">News carousel</a></li>
                            <li><a href="news-sidebar.html">News right sidebar</a></li>
                            <li class="is-new-menu"><a href="news-sidebar-left.html"><span>NEW</span>News left
                                    sidebar</a></li>
                            <li class="current"><a href="news-details.html">News details</a></li>
                        </ul>
                    </li>

							...
							<body class="bg-404">
								<section class="pd-5vw">
									<div class="">
										...
										<div class="text-size-6-vh text-purple dpd-20">
											<strong>
									...
									<div>
										...
										?>
										<a href="tel:{{ $hotline['content'] }}">Hotline</a> | 
										<a href="{{ $facebook['content'] }}" target="_blank">Facebook</a>
									</div>
								</section>

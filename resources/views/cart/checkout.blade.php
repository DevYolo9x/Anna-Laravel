            ...
            <div class="grid grid-cols-12 gap-5">
                ...
                <div class="col-span-12 lg:col-span-5 mt-4 mt-lg-0">
                    <div class="">
                        ...
                        <div class="bg-slate-100 md:p-10 p-2.5">
                            <div class="your-order-product-info">
                                        ...
                                        <div class="w-2/3 action-cart-item">
                                            ...
                                            <div class="flex count p-2 h-11" style="padding:0;margin: 5px 0 0 0;">
                                                <div class="flex items-center">
                                                    ...
                                                    <input type="number" min="1" max="{{ checkInventoryCheckout($v) }}" step="1" value="{{ $v['quantity'] }}" class="tp_cardQuantity border-white flex-auto w-20 h-10 text-center focus:outline-none input-appearance-none card-quantity">
                                ...
                                <ul class="flex flex-wrap items-center justify-between ">
                                    <li class="text-base font-semibold hide hidden">{{trans('index.TransportFee')}}</li>
                                    <li class="js_fee_shipping text-base font-semibold text-orange hide hidden"></li>
                                    <?php
                                    $fee_ship = 0;
                                    $title_ship = '';
                                    ?>
                        ...
                        <div class="mt-6">
                            <button type="submit" class="js_btn_submit bg-[#050708] block w-full text-center leading-none uppercase bg-global text-white text-sm bg-dark px-2 py-5 transition-all hover:bg-orange font-semibold">{{trans('index.Order')}}</button>
                        </div>
                    </div>
                </div>
            </div>

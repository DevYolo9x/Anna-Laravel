...
@section('title')
<title>Thêm mới danh mục dự án</title>
@endsection
<!--START: breadcrumb -->
@section('breadcrumb')
<?php
...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('category_projects.store')}}" method="post" enctype="multipart/form-data">
